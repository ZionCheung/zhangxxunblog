<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"E:\www\zhangxxunblog\public/../application/admin\view\article\addarticle.html";i:1537885663;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <div class="banner-box">
        <div class="layui-upload-list article-img">
    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item" style="display:flex;justify-content:center;">
            ...
            <div class="layui-input-inline" style="width:480px;">
                <input type="text" name="acleauthor" lay-verify="required" value="<?php echo $name; ?>" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
        ...
        <div class="layui-form-item" style="display:flex;justify-content:center;">
            ...
            <div class="layui-input-inline" style="width:480px;">
                <select name="acate" id="acate">
                    ...
                    <?php endforeach; endif; else: echo "分类为空" ;endif; ?>
                </select>
            </div>
            <div class="layui-form-mid layui-word-aux">
        ...
        <div class="layui-form-item" style="display:flex;justify-content:center;">
            ...
            <div class="layui-input-block" style="margin:0;padding:0 38px;">
                ...
                <input type="checkbox" name="tags" title="<?php echo $tags['tags_title']; ?>" value="<?php echo $tags['id']; ?>">
                <?php endforeach; endif; else: echo "暂时没有标签哦" ;endif; ?>
            </div>
        </div>
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
            <legend>文章正文</legend>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block" style="margin:0;padding:0 38px;">
                <textarea name="content" id="articleEditor" lay-verify="required" style="width:100%;"></textarea>
            </div>
        </div>
    ...
    <script>
        layui.use(['upload', 'form'], function () {
            ...
            form.on('submit(add)', function (data) {
                ...
                $.ajax({
                    type: 'post'
                    , url: "<?php echo url('admin/article/articleAddHandle'); ?>"
                    , data: { 'tags': tags, 'name': name, 'author': author, 'content': content, 'cate': cate, 'imgRoute': imgRoute }
                    , dataType: 'json'
