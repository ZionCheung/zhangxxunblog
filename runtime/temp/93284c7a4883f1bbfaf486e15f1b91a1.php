<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"E:\www\zhangxxunblog\public/../application/admin\view\user\adduser.html";i:1537885663;s:62:"E:\www\zhangxxunblog\application\admin\view\public\header.html";i:1537885663;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="checkbox" lay-skin="primary" title="<?php echo $vo['title']; ?>" value="<?php echo $vo['id']; ?>">
    ...
    <script>
        layui.use(['form', 'layer'], function () {
            ...
            form.on('submit(add)', function (data) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('admin/adminuser/addAdminUserHandle'); ?>",
